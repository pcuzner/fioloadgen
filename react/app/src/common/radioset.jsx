...
export class RadioSet extends React.Component {
    ...
    render() {
        ...
        if (this.props.config.horizontal) {
            radioGrpClass = "radio radio-common inline-block";
            labelClass = "radio-label-horizontal inline-block";
        } else {
        ...
        if (this.props.config.info) {
            radioGrp = (
                <div className="inline-block">
                    ...
                    <div>
                        <div className="radio-spacer inline-block">&nbsp;</div>
                        {buttons}
                    </div>
                </div>
            );
        ...
        return (
            <div>
                <div className="inline-block radio-container">
